...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <c:if test="${user.usrRoleId==4 || user.usrRoleId==3 || user.usrRoleId==1 }">
          <li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">营销管理</a>
            <dl class="layui-nav-child">
            <c:if test="${user.usrRoleId==3 || user.usrRoleId==1 }">
                <dd><a href="javascript:;">销售商机管理</a></dd>
              </c:if>
               <c:if test="${user.usrRoleId==4  || user.usrRoleId==1}">
        ...
        <c:if test="${user.usrRoleId==2 || user.usrRoleId==1}">
       <li class="layui-nav-item">
