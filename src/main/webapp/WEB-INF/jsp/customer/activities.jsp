...
<script type="text/javascript">
	   ...
	   $('.layui-body').load('activity/findActivitiesByCustId/'+custId+"/"+currentPage);
       }
	...
	$(function(){
		...
		$('.editUser').click(function(){
			...
			$.get(url,function(data){
				...
				activity = data;
				$("input[name=place]").val(activity.atvPlace);
				$("select[name=title]").val(activity.atvTitle);
				$("input[name=memo]").val(activity.atvMemo);   
			})
		})
		// 返回
